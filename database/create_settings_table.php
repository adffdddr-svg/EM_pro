...
<head>
    <meta charset="UTF-8">
    <title>إنشاء جدول الإعدادات</title>
    <style>
...
<body>
    <div class="container">
        <h1>🔧 إنشاء جدول الإعدادات</h1>
        
        <?php
        try {
            $db = getDB();
            
            echo "<div class='info'><strong>⚙️ جاري إنشاء جدول الإعدادات...</strong></div>";
            
            // قراءة ملف SQL
            $sql_file = __DIR__ . '/settings_schema.sql';
            ...
            echo "<h2 style='font-size: 24px; margin-bottom: 15px;'>✅ تم إنشاء جدول الإعدادات بنجاح!</h2>";
            ...
            echo "<p style='font-size: 20px; margin-top: 20px; color: #155724; font-weight: bold;'>✅ جدول الإعدادات جاهز الآن!</p>";
            echo "</div>";
            
            echo "<div style='text-align: center; margin-top: 40px;'>";
            echo "<a href='" . SITE_URL . "/admin/settings.php' class='btn'>";
            echo "✅ الذهاب إلى صفحة الإعدادات الآن";
            echo "</a>";
            echo "</div>";
